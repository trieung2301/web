...
const GLOBAL_FLASH_SALE_END_TIME = new Date(2025, 7 - 1, 29, 19, 41, 59).toISOString();
...
const allItemsData = [
    ...
    new Item(2, "Quạt mini cầm tay đa năng", 200000, "https://tse3.mm.bing.net/th/id/OIP.GZVtkcIKjRQ9qmfnjxtXSwHaFj?pid=Api&P=0&h=220", "Quạt mini nhỏ gọn, tiện lợi mang theo bên người. Có 3 chế độ gió, pin sạc bền bỉ.", "Thiết bị điện gia dụng", 100, true, 200000, 150000, 80),
    ...
    new Item(16, "Nồi chiên không dầu điện tử đa năng", 1250000, "https://tse3.mm.bing.net/th/id/OIP.EAFymZBZdljE0WYohZc39AHaHa?pid=Api&P=0&h=220", "Nồi chiên không dầu dung tích lớn, màn hình cảm ứng, chế độ nấu đa dạng, tốt cho sức khỏe.", "Thiết bị điện gia dụng", 70, false, null, null, 55),
    new Item(17, "Máy pha cà phê tự động chuyên nghiệp", 4200000, "https://tse3.mm.bing.net/th/id/OIP.LLng6GpilvBM5EFjYA4o-gHaFj?pid=Api&P=0&h=220", "Máy pha cà phê tự động, pha được nhiều loại đồ uống, dễ sử dụng và vệ sinh.", "Thiết bị điện gia dụng", 25, false, null, null, 18),
